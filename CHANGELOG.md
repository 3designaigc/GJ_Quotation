...
**SM-260414** 查船:HARBOUR ZIRCON(IMO9365166)已折返Kota Kinabalu→該批(5/21離港往基隆)早到港,標「已到港」。**SM-260415 原漏未追蹤(船名在NEXO文件、沒進船班追蹤)→補上:DANUM 173 V.73158E(IMO9406271),ETD6/18往基隆,船已折返馬來西亞,推估6/24到港。** 為防再漏,vessel_reminder **加掃 nexo_docs**:有船名卻未納入船班追蹤者跳⚠️。SM-260515 仍TBA(等BL)。`_最後查船`=2026-06-28。
